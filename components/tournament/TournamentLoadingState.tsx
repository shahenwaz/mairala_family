  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen space-y-6 sm:space-y-4 bg-background animate-fadeIn">
      ...
      <div className="relative w-16 h-16 sm:w-12 sm:h-12">
        <div className="absolute w-full h-full border-4 border-t-primary border-r-darkGray border-b-primary border-l-darkGray rounded-full animate-spin"></div>
      </div>
      ...
      <h1 className="text-2xl lg:text-4xl font-extrabold text-purple animate-bounce text-center">
...
export default TournamentLoadingState;
